        ...
        <div class="wrapper-page">
        	...
        	<div class="m-t-40 card-box">
				...
				<?php echo $this->Form->create('',['class'=>'form-horizontal m-t-20']); ?>
					...
					<h5 style="margin-top:0px; font-weight:normal;">For Pos</h5>
                    <h5 style="margin-top:0px; font-weight:normal;">Username: manager@cpos360.com<br>Password : 123456</h5>
					
					<h5 style="margin-top:0px; font-weight:normal;">For Kitchen</h5>
                    <h5 style="margin-top:0px; font-weight:normal;">Username: mkitchen@cpos360.com<br>Password : 123456</h5>
