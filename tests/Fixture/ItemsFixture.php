...
class ItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'price' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'short_description' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'added_date' => '2018-07-05 12:00:05',
                'modified_date' => '2018-07-05 12:00:05'
            ],
        ];
        parent::init();
    }
